...
## **Issue Summary**
Instance B is unable to reach the internet, while Instance A works correctly.

## **Findings**
After reviewing the VPC, subnet, routing, and instance configuration, the root cause was identified:

- **Instance B does not have a Public IPv4 address assigned.**
...
In this lab environment, public IP assignment after launch is restricted, so Instance B is intentionally private.
